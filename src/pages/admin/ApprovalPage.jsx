...
// Halaman ini telah diperbarui untuk menggunakan modal konfirmasi kustom.
...
const ApprovalPage = () => {
    ...
    const [confirmation, setConfirmation] = useState({
        ...
        message: '',
        onConfirm: () => {},
        intent: 'danger' // 'danger' (merah) atau 'success' (hijau)
    });
    ...
    // Fungsi yang dieksekusi setelah konfirmasi
    ...
    const closeConfirmation = () => setConfirmation({ isOpen: false, title: '', message: '', onConfirm: () => {}, intent: 'danger' });
    ...
    return (
        <>
            <ConfirmationModal 
                ...
                confirmText={confirmation.title.includes('Persetujuan') ? 'Approve' : 'Reject'}
                intent={confirmation.intent} // Meneruskan intent ke modal
            />
