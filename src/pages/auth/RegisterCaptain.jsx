...
const RegisterCaptain = () => {
  ...
  const handleBirthDateChange = (e) => {
    setBirthDateParts((prev) => ({ ...prev, [e.target.name]: e.target.value }));
  };
...
const handleSubmit = async (e) => {
    ...
    // 2. PERBAIKAN: Append data alamat dengan key yang BENAR
    ...
    // 4. PERBAIKAN: Append file dengan key 'selfie_image'
        ...
        <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-10">
            <FormSection title="Data Diri">
              ...
              />
              <InputField
                icon="https://icongr.am/feather/heart.svg?size=20&color=9ca3af"
                label="Status Pernikahan"
                id="marital_status"
                value={formData.marital_status}
                onChange={handleInputChange}
                hasError={errorField === 'marital_status'}
