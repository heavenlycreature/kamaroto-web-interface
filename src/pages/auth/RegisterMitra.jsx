                ...
                <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-10">
                        <FormSection title="Data Person In Charge (PIC)">
                            ...
                            <InputField icon="https://icongr.am/feather/smartphone.svg?size=20&color=9ca3af" label="Nomor HP / WA PIC" id="pic_phone" name="pic_phone" value={formData.pic_phone} onChange={handleInputChange} placeholder="081234567890" />
                        ...
                        <FormSection title="Data Pemilik Usaha">
                            ...
                            <InputField icon="https://icongr.am/feather/smartphone.svg?size=20&color=9ca3af" label="Nomor HP / WA Pemilik" id="owner_phone" name="owner_phone" value={formData.owner_phone} onChange={handleInputChange} placeholder="081234567890" />
                            ...
                            <InputField icon="https://icongr.am/feather/file-text.svg?size=20&color=9ca3af" label="No. Identitas / No. KTP Pemilik" id="owner_ktp" name="owner_ktp" value={formData.owner_ktp} onChange={handleInputChange} placeholder="Masukkan 16 digit nomor KTP" />
                            <div>
